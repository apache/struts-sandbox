 ...
 * Java package can specify different parent packages and
 * namespaces (using the {@link Namespace} annotation).
 * </p>
 *
 * <p>
 ...
 * <li>The struts configuration property <strong>struts.convention.action.default.parent.package</strong></li>
 * </ol>
 *
