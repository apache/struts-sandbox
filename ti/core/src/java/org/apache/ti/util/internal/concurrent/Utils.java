...
final class Utils {
    ...
    private final static String providerProp =
            "org.apache.ti.util.concurrent.NanoTimerProvider";
     ...
     * <code>org.apache.ti.util.concurrent.NanoTimerProvider</code>.
     ...
     * org.apache.ti.util.concurrent.locks.Condition#signal}
     * method for this
     * <tt>Condition</tt> and the current thread happens to be chosen as the
     * thread to be awakened; or
     * <li>Some other thread invokes the {@link
     * org.apache.ti.util.concurrent.locks.Condition#signalAll}
     * method for this
     * <tt>Condition</tt>; or
