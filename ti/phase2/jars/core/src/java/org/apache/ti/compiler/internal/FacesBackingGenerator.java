...
public class FacesBackingGenerator
    ...
    public void generate(ClassDeclaration publicClass)
        ...
        try {
            ...
            // Add the class-level @ti.facesBacking annotation.
            atx.include(publicClass, facesBackingAnnotation);

            // For each method, add the @ti.commandHandler annotation.
            ...
            // Add @ti.sharedFlowField, @ti.pageFlowField, @Control.
            ...
            getDiagnostics().addError(publicClass, "error.could-not-generate", AnnotationToXML.getFilePath(publicClass),
                                      e.getMessage());
